...
feature "An admin user" do
  ...
  context "can perform various actions on users" do
  ...
  context "can perform various actions on showings" do
    ...
    scenario "can view a specific showing" do
      visit admin_showing_path(@showing)
      expect(page).to have_content "Showing Details"
    end
